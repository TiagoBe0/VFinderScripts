...
class VacancyPredictionRunner:
    def __init__(self, archivo, predictor_small, predictor_large, predictor_rf_small, predictor_rf_large, predictor_xgb_small, predictor_xgb_large, other_method=False, save_training=False):
